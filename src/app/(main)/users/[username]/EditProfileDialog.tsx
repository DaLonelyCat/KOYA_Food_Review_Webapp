...
export default function EditProfileDialog({
  ...
  let fixedAvatarUrl = user.avatarUrl;
  if (fixedAvatarUrl && fixedAvatarUrl.includes(".ufs.sh/a/")) {
    fixedAvatarUrl = fixedAvatarUrl.replace(
      /\.ufs\.sh\/a\/[^/]+\//,
      ".ufs.sh/f/",
    );
  }
          ...
          <AvatarInput
            src={
              croppedAvatar
                ...
                : fixedAvatarUrl || avatarPlaceholder
            }
